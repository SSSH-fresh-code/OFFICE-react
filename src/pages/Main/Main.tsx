...
import UserProfileBtn from "../../widgets/Main/UserPofileBtn";
...
export default function Main({ isMenuOpen, setIsMenuOpen }: MainProps) {
  ...
  return (
    <>
      <div className="grid min-h-screen items-start gap-0 text-sm lg:grid-cols-[280px_1fr] relative z-0 top-0 left-0">
